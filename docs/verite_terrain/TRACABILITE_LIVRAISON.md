...
3. Sauvegarde testée par une restauration (R2/S3) : **ÉPROUVÉ en CI** avec MinIO réel et PostgreSQL 16 (Lot H.1, runs 35738002767, 35738011591, 35738937509, 35738944082, 35742665674, 35742670756, 35743433330 et 35743439266, 23/23 tests passés, restauration 50 000 fiches en 0,62 s - 1,34 s ; la base `f42e29b` reste ROUGE jusqu'à la fusion de la PR #21 ; le run de fusion (événement pull_request) est vert 8/8, donc la fusion rétablit la base).
