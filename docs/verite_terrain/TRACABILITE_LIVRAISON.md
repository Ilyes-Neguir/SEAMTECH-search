...
3. Sauvegarde testée par une restauration (R2/S3) : **ÉPROUVÉ en CI** avec MinIO réel et PostgreSQL 16 (Lot H.1, runs 35738002767, 35738011591, 35738937509, 35738944082, 35742665674 et 35742670756, 23/23 tests passés, restauration 50 000 fiches en 0,68 s - 1,34 s ; PR #21 répare la base `f42e29b` qui échouait au run 35731753595).
