...
try:
    from docs.verite_terrain.VERITE_7792_COMPLETE import VERITE_7792_COMPLETE

    VERITE_7792: dict[str, object] = dict(VERITE_7792_COMPLETE)
except ImportError:
...
VERITE_7792_COMPLETE = VERITE_7792
